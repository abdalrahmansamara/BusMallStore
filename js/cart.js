...
const trHeadElement = document.querySelector('#cart thead tr');
...
function clearCart() {
  const elements = document.querySelector('#cart tbody');
...
function showCart() {
  ...
  const bodyElement = document.querySelector('#cart tbody');
